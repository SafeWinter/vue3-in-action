# P4S32L86：Vue 第三方库 vue-chartjs 实战
...
1. 从 `chart.js` 导入一组组件，并进行 **注册**；
2. 从 `vue-chartjs` 导入图表组件，一般需要传入的参数：`data`、`options`
...
- [vue-chartjs 官网](https://vue-chartjs.org/)
- [Chart.js 官网](https://www.chartjs.org/docs/latest/) 
